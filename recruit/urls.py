...
from .views import FetchResumeView, JobCreateView, JobDetailView, JobProfileDetailsView, JobUpdateView, ProfileDetailView, ProfileListView, UpdateInterviewTimeView, UploadResumeView
